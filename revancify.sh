...
then
    ...
    then
        ...
        if su -c pm path com.google.android.youtube
        then
            sleep 1
            echo ""
    ...
    then
        ...
        if su -c pm path com.google.android.apps.youtube.music
        then
            sleep 1
            echo ""
